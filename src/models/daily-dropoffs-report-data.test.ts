  ...
  describe("#toStepCounts", () => {
    ...
    it("converts a single row into an array of steps with counts and percents", () => {
      expect(toStepCounts(row, FunnelMode.BLANKET)).to.deep.equal([
        ...
        { step: Step.PHONE_SUBMIT, count: 500, percentOfFirst: 5e-8, percentOfPrevious: 0.5 },
        { step: Step.ENCRYPT, count: 100, percentOfFirst: 1e-8, percentOfPrevious: 0.2 },
    ...
    it("starts at the image submit step for ACTUAL mode", () => {
      expect(toStepCounts(row, FunnelMode.ACTUAL)).to.deep.equal([
        ...
        { step: Step.PHONE_SUBMIT, count: 500, percentOfFirst: 5e-5, percentOfPrevious: 0.5 },
        { step: Step.ENCRYPT, count: 100, percentOfFirst: 1e-5, percentOfPrevious: 0.2 },
